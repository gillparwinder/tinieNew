    ...
    _defineProperty(this, "_startAnimation", action => {
      return new Promise(resolve => {
        ...
        _reactNative.Animated.timing(this._positionToast, {
          toValue: action === _ENV.ACTION.OPEN ? ((_this$context = this.context) === null || _this$context === void 0 ? void 0 : _this$context.top) ?? 0 : -this._cardHeight,
          duration: 250,
    ...
    _defineProperty(this, "_CardRender", () => {
      ...
      if (this.state.config) {
        const {
          ...
          onPress,
          onLongPress,
          titleStyle: titleCustomStyle,
          textBodyStyle: textBodyCustomStyle
        } = this.state.config;
        const titleStyle = titleCustomStyle || (config === null || config === void 0 ? void 0 : config.titleStyle);
        const textBodyStyle = textBodyCustomStyle || (config === null || config === void 0 ? void 0 : config.textBodyStyle);
        return /*#__PURE__*/React.createElement(_reactNative.Animated.View, {
          onLayout: _ref => {
            ...
            return this._cardHeight = height;
          },
